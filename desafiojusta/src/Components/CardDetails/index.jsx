    ...
    <>
      <div className="returnButtonContainer">
        <input
          type="image"
          onClick={() => handleHome()}
          alt="Retorne para a página inicial"
          title="Retorne à página inicial"
          src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcR5Co71aXTyPKfI5MFN5lAFGS46g3aUotEfVw&usqp=CAU"
        />
      </div>
